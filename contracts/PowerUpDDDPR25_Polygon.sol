...
/// @title PowerUp DDD/PR25 — Polygon
/// @notice WETH → split → half DDD + half PR25 → add DDD/PR25 LP → NFT contract
contract PowerUpDDDPR25_Polygon {
