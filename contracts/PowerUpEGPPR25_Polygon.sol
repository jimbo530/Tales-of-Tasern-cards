...
/// @title PowerUp EGP/PR25 — Polygon
/// @notice WETH → split → half EGP + half PR25 → add EGP/PR25 LP → NFT contract
contract PowerUpEGPPR25_Polygon {
