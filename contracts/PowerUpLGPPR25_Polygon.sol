...
/// @title PowerUp LGP/PR25 — Polygon
/// @notice WETH → split → half LGP + half PR25 → add LGP/PR25 LP → NFT contract
contract PowerUpLGPPR25_Polygon {
